/** 
 * Banco de preguntas: Examen Teórico de Ciencias — I Semestre (2ª Evaluación)
 * Maestra: Florisel Olmazo López · 5º Grado (Escuela Riojalandia)
 */
export const quizTeoricoCienciasSem1Eval2 = [
    {
