...
- **Examen teórico** → `quizTeoricoQuestions` / `quizTeoricoCiencias`
- **Examen práctico** → `quizPracticoQuestions` / `quizPracticoCiencias`
  ...
  options: [
    {
      ...
      isCorrect: true,
      rationale: "Explicación educativa detallada. Reforzar la regla matemática/científica. Mínimo 2 oraciones."
    },
    {
...
Agregar los objetos al array correspondiente.
